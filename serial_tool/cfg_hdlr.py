...
class ConfigurationHdlr:
    ...
    def save_cfg(self, path: str) -> None:
        ...
        # data[cfg_defs.keynoofcell] = self.data_cache.data_fields[0]
        # print(self.data_cache.data_fields[0])
        ...
        for idx, field in enumerate(self.data_cache.data_fields):
            ...
            print(cfg_defs.KEY_GUI_DATA_FIELDS + "[" + str(idx) + "]" + field)
    ...
    def load_cfg(self, path: str) -> None:
        ...
        try:
            ...
            # self.data_cache.set_data_field(data[cfg_defs.keynoofcell])
